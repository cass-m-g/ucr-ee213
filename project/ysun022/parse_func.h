...
Device_Entry *Reshead, *Restail;
Device_Entry *Caphead, *Captail;
Device_Entry *CapIChead, *CapICtail;
Device_Entry *Indhead, *Indtail;
Device_Entry *IndIChead, *IndICtail;
Device_Entry *Vsrchead, *Vsrctail;
Device_Entry *Isrchead, *Isrctail;
Device_Entry *VCCShead, *VCCStail;
Node_Entry *Nodehead, *Nodetail;
